...
(function () {
  "use strict";
  if (!window.MTECH_DB || !window.MTECH_CLOUDINARY) return;
  ...
  MTECH_DB.saveProduct = function (id, data) {
    var copy = enrichArray(data, "images"), main = copy.thumbnail || copy.image, mainMedia = main ? mediaFor([main])[0] : null;
    ...
    return originalProduct.call(MTECH_DB, id, copy);
  };
  var originalCategory = MTECH_DB.saveCategory;
  MTECH_DB.saveCategory = function (id, data) { return originalCategory.call(MTECH_DB, id, enrichSingle(data, "image")); };
